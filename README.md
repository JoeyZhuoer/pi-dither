...
- **Particle field (optional):** the Appearance window can add drifting particles over the desk in three densities. Nearby particles link with faint lines, the pointer stirs them, and collisions flash a small ring. It pauses when the tab is hidden and draws a single static frame under reduced motion.
