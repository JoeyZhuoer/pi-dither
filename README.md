...
- **Dot interaction:** moving the pointer across a dithered photo stirs it in the reference-field style: dots within 10px swirl and spread, faint constellation lines fan out to distinct dots within 40px, and everything settles back exactly to the original pattern.
