...
- **Plain background:** the desktop is a flat dusty-pink ground with no pattern, canvas, animation or motion preference. Aggregated fleet activity is still reported to the UI (`#desktop[data-activity]`) and drives the activity window, but it paints nothing.
