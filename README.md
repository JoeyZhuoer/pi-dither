...
- **Dot interaction:** moving the pointer across a dithered photo spreads the dots inside a small 64px radius and they settle back exactly to the original pattern.
