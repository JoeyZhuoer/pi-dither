...
const appFiles = [
  ...
  ...['app.js', 'background.js', 'particles.js', 'motion.js', 'delegated.js', 'inspection.js', 'inspection.css', 'combobox.js', 'combobox.css', 'features.js', 'features.css', 'markdown.js', 'markdown.css', 'windows.js', 'widgets.js', 'widgets.css', 'widget-usage.js', 'widget-model.js', 'index.html', 'styles.css', 'assets/VT323-Regular.ttf', 'assets/OFL.txt'].map((name) => `desktop/public/${name}`),
];
