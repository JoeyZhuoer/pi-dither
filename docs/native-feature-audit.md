...
| Plain background | Unit/browser/native assertions that no canvas, pattern or motion control exists and that fleet activity is still reported | Pass; visual layer is the window chrome only |
