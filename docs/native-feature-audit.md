...
| Window settings chooser | Browser and native fixtures (less frequent windows start out of the menu, ticking adds, unticking removes, a hidden window opens directly, choice persists) | Pass; all windows remain reachable from the ⚙ list |
